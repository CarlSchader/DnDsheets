...
populateLargeFields = function(section, inputFields) {
  ...
  for(var i = 0; i < section.length; i++) {
    ...
    inputFields.innerHTML += '<div id="characterSheets-largeFields' + i + '" class="form-group">' + '<label for="exampleFormControlTextarea1"><span class="badge badge-dark">' + name + '</span></label>' + '<textarea class="form-control" id="exampleFormControlTextarea1" rows="' + lines + '"></textarea>' + '</div>'
  }
}
